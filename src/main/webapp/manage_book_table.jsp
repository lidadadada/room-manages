    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                <li class="active"><a href="#">预定管理 <span class="sr-only">(current)</span></a></li>
	...
	<script type="text/javascript">
		...
		$(document).on("click","#table_edit_btn",function () {
			...
			$("#book_edit_save_btn").click(function () {
				$.ajax({
					url:"${APP_PATH}/book/manage/update/",
					type:"POST",
					data:"serialNum="+$(this).attr("edit_id")+"&"+$("#bookEditModal form").serialize(),
					success:function(results){
						alert(results.msg);
						$("#bookAddModal").modal('hide');
						to_page(totalRecord + 1);
